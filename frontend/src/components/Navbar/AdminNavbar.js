        ...
        <div>
            <nav className="navbar navbar-expand-lg bg-body-tertiary shadow-lg p-3 mb-5 bg-body-tertiary rounded">
                <div className="container-fluid">
                    <a className="navbar-brand" href="/userDetails">SPYEYE</a>
                    ...
                    <ul className="navbar-nav ms-auto">
                        ...
                        <li className="nav-item">
                            <a className="nav-link" aria-current="page" href="/branch">Branches</a>
                        </li>
                        <li className="nav-item">
                            <a className="nav-link" aria-current="page" href="/supplier">Supplier</a>
                        </li>
                        <li className="nav-item">
